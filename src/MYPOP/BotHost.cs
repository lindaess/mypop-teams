...
namespace MYPOP
{
    ...
    public class BotHost : IBotHost
    {
        ...
        {
            _logger.LogInformation("Starting the MYPOP Bot");
            ...
            builder.Services.AddSingleton<IGraphLogger, GraphLogger>(_ => new GraphLogger("MYPOPWorker", redirectToTrace: true));
            builder.Services.AddSingleton<IBotMediaLogger, BotMediaLogger>();
            builder.Logging.AddApplicationInsights();
            builder.Logging.SetMinimumLevel(LogLevel.Information);

            builder.Logging.AddEventLog(config => config.SourceName = "MYPOP Bot Service");
